import mostfreqelement from './qn2.ts'

const testCases:obj[] = [{ expected : 3 , input:  [1,2,2,3,3,3,4] },
    { expected : "a", input: ["a","b","a","c","d","c","a"] },
...
function test(testCases:obj[]):void {
    ...
    const result:string | number | boolean = mostfreqelement(testCase.input);
